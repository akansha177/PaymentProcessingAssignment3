package com.example.payment_processing.aspect;



import com.example.payment_processing.entity.AuditEntry;
import com.example.payment_processing.repository.AuditRepository;
...
public class AuditAspect {
    ...
    @Pointcut("execution(* com.example.payment_processing.controller.WalletController.*(..)) || " +
            "execution(* com.example.payment_processing.controller.TransactionController.*(..))")
