package com.example.payment_processing.serviceImpl;


import com.example.payment_processing.entity.User;
import com.example.payment_processing.exceptions.UserAlreadyEnrolledException;
...
public class UserServiceImpl implements UserService {
    ...
    public void enrollForOfflinePayment(int user_id){
